...
appProperties.load(FileInputStream(rootProject.file("application.properties")))
...
android {
    ...
    signingConfigs {
        val keystoreFile = appProperties.getProperty("keystore.file") ?: ""
        if (keystoreFile.isNotBlank()) {
            create("config") {
                storeFile = file(File(rootDir, keystoreFile))
                storePassword = appProperties.getProperty("keystore.password") ?: ""
                keyAlias = appProperties.getProperty("keystore.key.alias") ?: ""
                keyPassword = appProperties.getProperty("keystore.key.password") ?: ""
